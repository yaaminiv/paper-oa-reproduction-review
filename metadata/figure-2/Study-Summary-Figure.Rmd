...
```{r}
yearMetadata <- allMetadata %>% select(., taxa, year) #Keep columns necessary for reproduction category
...
plot(yearPublished$totCnidarian, type = "l", col = dichromat(yearColors[1]), ylim = c(0,100), lty = 4, lwd = 3)
...
plot(yearPublished$totCnidarian[-1], type = "l", ylim = c(0,100),
...
axis(side = 2, at = seq(0, 100, 10), labels = seq(0, 100, 10), las = 2, col = "grey80", cex.axis = 2) #Add y-axis with paper count information
