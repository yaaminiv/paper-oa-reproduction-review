...
cnidarianMetadata <- cnidarianMetadata %>% 
  select(., Reproductive.Stage, Effect..Y.N.., Year, Collection.Location..Marine.Ecoregion) %>% 
...
```{r}
#Make type row name, then remove category and type columns
...
```{r}
barplotColors <- c("grey90", "grey10") #Create a red-blue palette with 3 colors to represent positive, neutral, and negative effects of ocean acidification on reproductive processes
