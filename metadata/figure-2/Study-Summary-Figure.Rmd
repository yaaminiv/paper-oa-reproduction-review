...
```{r}
#Group yearMetadata by taxa and year, count studies per taxa/year, make taxa columns, replace NA with 0, reorganize by year, then add cumulative sums for each taxa and save as another column
